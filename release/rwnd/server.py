...
class ThreadedServer():
    def __init__(self):
        ...
        self.s.setsockopt(socket.SOL_TCP, socket.TCP_QUICKACK, 1)
        # self.s.setsockopt(socket.SOL_SOCKET, socket.SO_RCVBUF, 34000) # comment this line for not bottleneck
        self.s.setsockopt(socket.SOL_SOCKET, socket.SO_RCVBUF, 65535) # comment this line for not bottleneck
